...
function startApp() {
    $.getJSON('CryptoZombies.json', function(data) {
        var CryptoZombiesArtifact = data;
        cryptoZombies = TruffleContract(CryptoZombiesArtifact);
...
function createRandomZombie(name) {
    ...
    debugger
    cryptoZombies.deployed().then(async function(instance){
        const object = await instance.createRandomZombie(name, { from: userAccount });
        debugger;
        return object
